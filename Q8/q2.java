...
public class q2 extends GiftSelector{
	...
	q2() throws IOException{
		...
		int num_happ_coup;
		/**
		 * choice 0 for first giftify, 1 for new giftify
		 */
		int choice;
		nb = 7; ng = 5; k = 0; z = 0; num_happ_coup = 3; //nb = no.of boys, ng = no.of girls, num_happ_coup = no.of happiest couples to be found
		Scanner sc = new Scanner(System.in);
		System.out.println("Enter choice | 0 for first type giftify, 1 for special giftify");
		choice = sc.nextInt();
		choice = choice%2;
		Boys b[] = new Boys[nb];
		...
		switch(choice) {
			...
			case 1: 
				giftifyoptimized(b, g, happinessarray);
				break;
